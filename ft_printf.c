...
/*   Updated: 2025/09/14 20:12:17 by luozguo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* #define TEST_PRINTF(format, ...) \
    do { \
        ...
        fflush(stdout); fflush(stderr); \
        if (my != pf) { \
            printf("\033[31m[RET MISMATCH] \
                My: %d, pf: %d  at %s:%d\033[0m\n\n", \
                   my, pf, __FILE__, __LINE__); \
        } else { \
            printf("\033[32m[RET OK] \
                My: %d, pf: %d\033[0m\n\n", my, pf); \
        } \
    } while (0) 
*/
...
//     printf("\n=== 8. Odd
//	/ Undefined Sequences (glibc defined behavior) ===\n");
//     TEST_PRINTF("%0. 12.6s\n", "hell");
//     TEST_PRINTF("%. d\n", 42);
